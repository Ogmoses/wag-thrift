...
async function renderPlanDetail(planId) {
  ...
  const ptc=document.getElementById('planTypeCard'); if(ptc) ptc.textContent=(plan.frequency||'Daily');
  ...
  const pnd=document.getElementById('planNameDisplay'); if(pnd) pnd.textContent=plan.name||'My Plan';
